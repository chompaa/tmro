declare module "react-beautiful-dnd" {
  ...
  export interface DragDropContextProps extends Responders {
    children: Preact.JSXInternal.Element | null;
  ...
  export class DragDropContext extends Preact.Component<DragDropContextProps> {}
  ...
  export interface DroppableProvided {
    ...
    placeholder: Preact.JSXInternal.Element;
  ...
  export interface DroppableProps {
    ...
    ): Preact.JSXInternal.Element<HTMLElement>;
  }

  export class Droppable extends Preact.Component<DroppableProps> {}
  ...
  export interface DraggableProvidedDraggableProps {
    // inline style
    style?: DraggingStyle | NotDraggingStyle | undefined | any;
    // used for shared global styles
  ...
  export class Draggable extends Preact.Component<DraggableProps> {}
